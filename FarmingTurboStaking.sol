...
contract FarmingTurboStaking is Ownable {
    ...
    address public trustedDepositTokenAddress = 0xe4a43f8Bdaf4fC6a3b118A5448983fe783724BC8;//Adresse Turbo

    address public trustedRewardTokenAddress = 0xe4a43f8Bdaf4fC6a3b118A5448983fe783724BC8; 

    // Amount of tokens
    uint public disburseAmount = 60000e18; //
    ...
    uint public adminCanClaimAfter = 1 minutes;
    ...
    // uint private next_turbo = 28800;
    
    // uint private duree_turbo = 7200;
    
    uint public next_turbo = 120;
    
    uint public duree_turbo = 60;
    ...
    uint public minSecTurboStart = 300; // 5 MIN
    uint public maxSecTurboStart = 420; // 7MIN
    
    uint public minSecTurboDuration = 300; // 5 MIN
    uint public maxSecTurboDuration = 300; // 5 MIN
   ...
   function randomTurboStart() public onlyOwner view returns (uint)   {
    ...
    function randomTurboduration() public onlyOwner view returns (uint)  {
